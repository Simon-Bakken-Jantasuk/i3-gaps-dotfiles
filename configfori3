...
# Randomizes background image for feh
exec feh  --bg-scale  ~/Media/Pictures/wrath.jpg

# Background image for feh
# exec_always bash ~/.config/polybar/config_directory/scripts/pywal.sh/{PICTURE}

# Keybind for the application flameshot
exec_always flameshot
bindsym Print exec flameshot full --path ~/snap/flameshot/flameshotfull
bindsym Shift+Print exec flameshot gui

# Disable window titlebars in order to use i3-gaps
for_window [class=".*"] border pixel 0

# gaps configuration for i3-gaps
gaps inner 10 
gaps outer 15 
